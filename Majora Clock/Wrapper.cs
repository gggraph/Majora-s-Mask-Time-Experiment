...
namespace Majora_Clock
{
 ...
 bool unicode, bool casesensitive, bool percentage, bool compareToSavedScan, [MarshalAs(UnmanagedType.BStr)] string savedscanname);
        ...
        public void FirstScan
            ...
            string startscan,
            string endscan,
            Tscanregionpreference writable,
            Tscanregionpreference executable,
            Tscanregionpreference copyOnWrite,
        ...
        {
            this.iConfigScanner(writable, executable, copyOnWrite);
            this.iFirstScan(scanopt, varopt, TRoundingType.rtRounded, value,
            value2, startscan, endscan, false, false, unicode, casesensitive,
            fastscanmethod, alignement);
